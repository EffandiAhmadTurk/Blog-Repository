...
export default function Home() {
    return (
        <>
            <div className="py-24  flex-col gap-2 items-center justify-center  px-4">
                <h1 role="heading" className="text-center mt-72 xl:text-5xl md:text-4xl text-2xl font-bold text-gray-800">
                    Read Our Latest
                </h1>
                ...
                <div className=" flex flex-wrap items-start space-x-6 justify-center pt-6 gap-6">
